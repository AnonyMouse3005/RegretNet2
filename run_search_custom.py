...
def main():
    ...
    # experiment settings
    weighted = True
    data_distributions = ['uniform', 'normal', 'beta1', 'beta2']  # ['uniform', 'normal', 'beta1', 'beta2']
    devices = [0]
    ...
    for data_distribution in data_distributions:
        tag = f'search_{data_distribution}_weighted' if weighted else f'search_{data_distribution}_unweighted'
